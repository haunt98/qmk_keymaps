...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_QWERTY] = LAYOUT_60_tsangan_hhkb(
        ...
        SC_LSPO,  KC_Z,     KC_X,     KC_C,    KC_V,     KC_B,    KC_N,    KC_M,  KC_COMM,  KC_DOT,  KC_SLSH,  SC_RSPC,  MO_NAV,
        XXXXXXX,  KC_LOPT,  KC_LCMD,  KC_SPC,  KC_RCMD,  MO_OPT,  XXXXXXX
    ),
