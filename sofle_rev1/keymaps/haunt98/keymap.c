...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_QWERTY] = LAYOUT(
        ...
        KC_UNDS,  LOPT_BRC,  KC_LCMD,  LT_SYM_SPC,  KC_SPC,  KC_ENT,  MO_NAV,   KC_ENT,   ROPT_BRC,  KC_COLN
    ),
    [LAYER_SYM] = LAYOUT(
        KC_GRV,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,
        _______,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_MINS,  KC_UNDS,  KC_EQL,   KC_PLUS,  XXXXXXX,  KC_F12,
        _______,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_LBRC,  KC_LCBR,  KC_RCBR,  KC_RBRC,  XXXXXXX,  XXXXXXX,
        _______,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  _______,  _______,  KC_BSLS,  KC_PIPE,  XXXXXXX,  XXXXXXX,  XXXXXXX,  _______,
