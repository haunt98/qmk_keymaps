...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_QWERTY] = LAYOUT(
        ...
        KC_LCTL,        KC_LOPT,  KC_LCMD,  LT_SYM_SPC,  KC_SPC,  KC_ENT,  MO(LAYER_NAV),  KC_ENT,   KC_ROPT,  KC_RCTL
    ),
    [LAYER_SYM] = LAYOUT(
        ...
        _______,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  _______,  _______,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_MINS,  KC_EQL,  _______,
